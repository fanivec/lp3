    ...
    if($_GET['act']=='insert'){
        if(isset($_POST['Guardar'])){
            ...
            while($row = mysqli_fetch_array($sql)){
                ...
                precio, cantidad) VALUES ($cod_producto, $codigo, $codigo_deposito, $precio, $cantidad)")
            ...
            nro_factura, fecha, hora, estado, total_compra, id_user, timbrado, f_venc)
            VALUES ($codigo, $codigo_proveedor, $codigo_deposito, '$nro_factura', '$fecha', '$hora',
            '$estado', '$total_compra', '$usuario', '$timbrado', '$f_venc')")
            or die('Error'.mysqli_error($mysqli));
