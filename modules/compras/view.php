                    ...
                    <table id="dataTables1" class="table table-bordered table-striped table-hover">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="center">Total Compra</th>  
                        ...
                        <tbody>
                            ...
                            while($data = mysqli_fetch_assoc($query)){
                               ...
                               <div>";?>
                               <a data-toggle="tooltip" data-placement="top" title="Anular Registro de Compra" class="btn btn-danger btn-sm"
                                ...
                                <a data-toggle="tooltip" data-placement="top" title="Imprimir Registro de Compra" class="btn btn-warning btn-sm" 
