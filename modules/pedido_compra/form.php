...
$name_user=$data['name_user'];
    ...
    if($_GET['form']=='add'){ ?>
      ...
      <h1>
        <i class="fa fa-edit icon-title">Agregar Pedidos de Compras</i>
      </h1>
      <ol class="breadcrumb">
        <li><a href="?module=start"><i class="fa fa-home"></i>Inicio</a></li>
        <li><a href="?module=pedido_compra">Pedido Compras</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    <form role="form" class="form-horizontal" action="modules/pedido_compra/proses.php?act=insert" method="POST">
                        <div class="box-body">
                            <?php
                            //Método para generar código
                                $query_id = mysqli_query($mysqli, "SELECT MAX(cod_pedido_compra) as id FROM pedido_compra")
                                                        or die('Error'.mysqli_error($mysqli));
                            ...
                            <div class="box-footer">
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        ...
                                        <a href="?module=pedido_compra" class="btn btn-default btn-reset">Cancelar</a>
                                    </div>
                                </div>
                            </div>
