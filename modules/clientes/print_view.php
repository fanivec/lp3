        ...
        <table width="100%" border="0.3" cellpadding="0" cellspacing="0" align="center">
                ...
                <?php
                    while ($data = mysqli_fetch_assoc($query)){
                        ...
                        echo "<tr>
                        <td width='100' align='center'>$ci_ruc</td>
                        <td width='120' align='center'>$dep_descripcion</td>
                        <td width='120' align='center'>$descrip_ciudad</td>
                        <td width='120' align='center'>$cli_nombre</td>
                        <td width='120' align='center'>$cli_apellido</td>
                        <td width='120' align='center'>$cli_telefono</td>
                        </tr>";
                    }
                ?>
                </tbody>
