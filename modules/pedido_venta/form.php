...
$name_user=$data['name_user'];
    ...
    if($_GET['form']=='add'){ ?>
      ...
      <h1>
        <i class="fa fa-edit icon-title">Agregar Pedidos de Ventas</i>
      </h1>
      <ol class="breadcrumb">
        <li><a href="?module=start"><i class="fa fa-home"></i>Inicio</a></li>
        <li><a href="?module=pedido_venta">Pedido Ventas</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    <form role="form" class="form-horizontal" action="modules/pedido_venta/proses.php?act=insert" method="POST">
                        <div class="box-body">
                            <?php
                            //Método para generar código
                                $query_id = mysqli_query($mysqli, "SELECT MAX(cod_pedido_venta) as id FROM pedido_venta")
                                                        or die('Error'.mysqli_error($mysqli));
                            ...
                            <div class="box-footer">
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        ...
                                        <a href="?module=pedido_venta" class="btn btn-default btn-reset">Cancelar</a>
                                    </div>
                                </div>
                            </div>
