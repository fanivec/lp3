...
<html>
  <head>
    ...
    <meta name="author" content="Roque Acosta" />
  ...
  <body class="skin-blue fixed" background="assets/img/fondo.jpg">
    <div class="wrapper">
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; <?php echo date('Y');?> - <a href="#">UTIC - Proyecto Web</a></strong> <p><a href="" target="_blank"> Desarrollado por Fani Vera</a></p>
      </footer>--> 
    </div><!-- ./wrapper -->
